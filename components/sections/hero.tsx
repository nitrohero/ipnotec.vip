...
export function HeroSection() {
    ...
    useEffect(() => {
        // Initialize particles on mount - OPTIMIZED: Reduced from 20 to 10 particles
        setMounted(true)
        ...
        // Set loaded state after a short delay to ensure smooth appearance
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 md:pt-40">
                ...
                {!isLoaded && (
                    ...
                    >
                        <motion.div
                            ...
                            className="text-green-400 text-2xl font-heading"
                        >
            ...
            {/* Floating Orbs - OPTIMIZED: Reduced blur from blur-3xl to blur-2xl */}
            <div className="absolute inset-0 overflow-hidden">
                <motion.div
                    className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-green-400/10 blur-2xl"
                    animate={{
                        x: [0, 50, 0],
                        y: [0, -30, 0],
                        scale: [1, 1.1, 1],
                ...
                />
                <motion.div
                    className="absolute top-3/4 right-1/4 w-48 h-48 rounded-full bg-blue-400/10 blur-2xl"
                    animate={{
                        x: [0, -40, 0],
                        y: [0, 40, 0],
                        scale: [1, 0.9, 1],
